...
import { SamplingMethod, SubMethod, Unit, SamplingConfig } from './SamplingTypes';
import { generatePopulation, performSampling, calculateStats } from '../utils/sampling/samplingLogic';
import Visualizer from './Visualizer';
import StatsBoard from './StatsBoard';
import MethodExplanation from './SampleDetails';

const SamplingVisualization: React.FC = () => {
    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-slate-50">
      <aside className="w-full lg:w-96 bg-white border-r border-slate-200 p-8 flex flex-col gap-6 overflow-y-auto h-screen">
        <div className="pb-4 border-b border-slate-100">
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Sample Visualization</h1>
