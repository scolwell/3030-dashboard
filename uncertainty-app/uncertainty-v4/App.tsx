                  ...
                  <div className="mt-8 bg-slate-900 text-white p-8 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-sm text-slate-300 leading-relaxed font-medium">
                        Choosing <span className="text-white font-bold">&alpha; = {state.alpha}</span> is a commitment to being wrong no more than {state.alpha * 100}% of the time when claiming a discovery that doesn't exist.
                      </p>
                    </div>
                  </div>
                )
