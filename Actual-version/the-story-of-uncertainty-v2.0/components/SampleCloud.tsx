...
const SampleCloud: React.FC<Props> = ({ onSampleDrawn, highlightSample }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md aspect-[10/9] bg-slate-50 rounded-[2.5rem] border-2 border-slate-100 shadow-inner overflow-hidden mb-8">
        {population.map((dot) => {
      ...
      <div className="flex flex-col items-center gap-6 w-full max-w-sm">
        ...
        <div className={`px-6 py-3 rounded-2xl border flex items-center justify-between transition-colors duration-500 ${
          selectedIndices.length === sampleSize 
            ...
            : 'bg-indigo-50/50 border-indigo-100/50 opacity-50'
        }`}>
